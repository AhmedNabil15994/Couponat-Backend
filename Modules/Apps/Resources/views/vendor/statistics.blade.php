                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-actions col-md-3">
                                                    ...
                                                    <a class="btn btn-sm red btn-outline filter-cancel"
                                                       href="{{url(route('vendor.statistics'))}}">
                ...
                <div class="row">
                    <div class="portlet light bordered col-lg-12">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb-25">
                            <a class="dashboard-stat dashboard-stat-v2 yellow" href="@can('show_orders'){{url(route('vendor.orders.index'))}}@else{{url(route('vendor.reports.offers'))}} @endcan">
                                <div class="visual">
...
{{--                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb-25">--}}
{{--                            <a class="dashboard-stat dashboard-stat-v2 orange" href="@can('show_orders'){{url(route('vendor.orders.active_orders'))}}@else{{url(route('vendor.reports.offers'))}} @endcan">--}}
{{--                                <div class="visual">--}}
{{--                                    <i class="fa fa-building-o"></i>--}}
{{--                                </div>--}}
{{--                                <div class="details">--}}
...
{{--                        </div>--}}
{{--                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb-25">--}}
{{--                            <a class="dashboard-stat dashboard-stat-v2 blue" href="{{url(route('vendor.offers.index'))}}">--}}
{{--                                <div class="visual">--}}
{{--                                    <i class="fa fa-building-o"></i>--}}
{{--                                </div>--}}
{{--                                <div class="details">--}}
...
{{--                               href="{{url(route('vendor.orders.index'))}}" style="color: white">--}}
