...
{{--                                        </div>--}}
                                        ...
                                        {!! field()->date('user_valid_from',__('offer::dashboard.offers.form.user_valid_from'),$model->user_valid_from) !!}
                                        {!! field()->date('user_valid_until',__('offer::dashboard.offers.form.user_valid_until'),$model->user_valid_until) !!}
{{--                                        <div class="form-group">--}}
{{--                                            <label class="col-md-2">--}}
        ...
        $(function(){
            ...
            $(document).on('click','.fileinput-remove',function (){
                if($(this).attr('multiple')){
                    ...
                    $.ajax({
                        type:'post',
                        url: "{{route('dashboard.offers.deleteMediaFiles')}}",
                        data:{
