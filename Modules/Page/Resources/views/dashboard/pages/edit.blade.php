                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active fade in" id="global_setting">
                                <div class="col-md-10">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in {{ ($code == locale()) ? 'active' : '' }}" id="colored-rounded-tab-general-{{$code}}">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="title[{{$code}}]" class="form-control" data-name="title.{{$code}}" value="{{ $model->getTranslations('title')[$code] }}" {{ (is_rtl($code) == 'rtl') ? 'dir=rtl' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="description[{{$code}}]" rows="8" cols="80" class="form-control {{is_rtl($code)}}Editor" data-name="description.{{$code}}">{{ $model->getTranslations('description')[$code] }}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    {!! field()->number('order', __('category::dashboard.categories.form.sort'), $model->order) !!}
