                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover"
                                ...
                                <tr>
                                    ...
                                    <th>{{__('user::dashboard.users.datatable.is_verified')}}</th>
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    columns: [
                        ...
                        {
                            data: "is_verified", orderable: false, width: "1%",
                            render: function (data, type, row) {
                                if (data == true) {
                                    return `<span class="btn btn-success">{{__('user::dashboard.users.datatable.verified')}}</span>`
                                } else {
                                    var showUrl = '{{ route("dashboard.users.verify", ":id") }}';
                                    showUrl = showUrl.replace(':id', row.id);
                                    return `<a href="${showUrl}">
                                    <span class="btn btn-danger">{{__('user::dashboard.users.datatable.not_verified')}}
                                    </span>
                                    </a>`
                                }
                            }
